...
// HMR-safe AppLayout singleton
if (!(window as any).__fuse_app_layout__) {
  (window as any).__fuse_app_layout__ = (props: { children: React.ReactNode }) => {
...
export default (window as any).__fuse_app_layout__;
